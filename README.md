# Програмнe забезпечення для аналізу ефективності роботи працівників використовуючи ключові показники ефективності (KPI) на основі даних із Git-репозиторіїв
## Функціонал:
